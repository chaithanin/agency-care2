...
# ── ชุดสีสำหรับกราฟ ─────────────────────────────────────────
# ลำดับคงที่ ห้ามวนใช้ซ้ำ — ตรวจด้วย scripts/validate_palette.js ของ dataviz แล้ว
# บนพื้นการ์ดจริงของแอป (#111827) โหมด dark ผ่านทุกข้อ
#   ช่องทาง 5 สี   worst adjacent CVD ΔE 8.4 (protan) · normal 19.3
#   กลุ่มผู้ติดต่อ 4 สี  worst adjacent CVD ΔE 8.4 · normal 19.8
#   เส้นแนวโน้ม 3 สี    worst adjacent CVD ΔE 9.4 · normal 26.5
SERIES = ["#3987e5", "#d95926", "#199e70", "#c98500", "#d55181"]
S_BLUE, S_ORANGE, S_AQUA, S_YELLOW, S_MAGENTA = SERIES

# สีสถานะ — สงวนไว้ ห้ามเอาไปใช้เป็นสีของ series
ST_GOOD, ST_WARN, ST_SERIOUS, ST_CRIT = "#0ca30c", "#fab219", "#ec835a", "#d03b3b"

GRID = "#2A3441"   # เส้นกริดจาง ๆ ให้ถอยหลังจากข้อมูล
